...
//Parameters
//b: Vector matrix or n-dimensional array (intended to be the numerator coefficients of the filter transfer function)
//a: Vector matrix or n-dimensional array (intended to be the denominator coefficients of the filter transfer function)
//Description
//[b,a] = eqtflength(b,a)
