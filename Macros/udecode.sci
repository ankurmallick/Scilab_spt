...
//Parameters
//u: A vector, matrix or n-dimensional array of integers
//n: An integer between 2 and 32
//v: A positive real scalar 
//saturatemode: A string which can take only 2 values 'saturate' or 'wrap'
//Description
